...
const SCENE_PROMPT = `
Given the following media file, summary, actors, and characters, extract the details of the scene using screen play script format between time frames {{ .TIME_START }} - {{ .TIME_END }}.
